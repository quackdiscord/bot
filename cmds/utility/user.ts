...
// create the command
const command = new SlashCommandBuilder().setName("user").setDescription("Get some info about a user.");
    ...
    const embedData = {
        ...
        fields: [
            ...
            },
            {
                name: "Joined Server",
                value: `${
                    time(interaction.guild?.members.cache.get(user.id)?.joinedAt || new Date(), "F") || "Unknown"
                }\n(${
