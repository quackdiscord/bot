...
// create the command
const command = new SlashCommandBuilder().setName("qr").setDescription("Generate a QR code for a link");

// add the options
command.addStringOption((option) =>
    option.setName("link").setDescription("The link you want a QR code for").setRequired(true)
);
