...
command.addSubcommand((subcommand) =>
    subcommand
        ...
        .addNumberOption((option) =>
            option.setName("amount").setDescription("The number of messages to purge").setRequired(true)
        )
        .addChannelOption((option) =>
            option
                .setName("channel")
                .setDescription("The channel to purge messages from, defaults to the current channel")
        )
);
...
command.addSubcommand((subcommand) =>
    subcommand
        ...
        .addUserOption((option) =>
            option.setName("user").setDescription("The user to purge messages from").setRequired(true)
        )
        .addNumberOption((option) =>
            option.setName("amount").setDescription("The number of messages to purge").setRequired(true)
        )
...
command.addSubcommand((subcommand) =>
    subcommand
        ...
        .addStringOption((option) =>
            option.setName("emoji").setDescription("The emoji to search for").setRequired(true)
        )
        .addNumberOption((option) =>
            option.setName("amount").setDescription("The number of messages to purge").setRequired(true)
        )
...
command.addSubcommand((subcommand) =>
    subcommand
        ...
        .addStringOption((option) =>
            option.setName("string").setDescription("The string to search for").setRequired(true)
        )
        .addNumberOption((option) =>
            option.setName("amount").setDescription("The number of messages to purge").setRequired(true)
        )
