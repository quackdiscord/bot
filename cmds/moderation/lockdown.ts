...
// create the command
const command = new SlashCommandBuilder().setName("lockdown").setDescription("Lockdown a channel or the server");
...
command.addSubcommand((subcommand) =>
    subcommand
        ...
        .addChannelOption((option) =>
            option
                .setName("channel")
                .setDescription("The channel to lockdown. Defaults to the current channel if not specified.")
                .setRequired(false)
        )
);
